...
//'machete', 'butter knife', 'dagger', 'pistol'];

//'Jack', 'One-Eyed Willie', 'Feddie', 'Davie', 'Fred'];

let phrase = 'Hello World!'

console.log(phrase);let weapon = 'machete'
console.log(weapon == 'machete');
console.log(weapon == 'dagger');
console.log(weapon == 'butter knife');

let name = 'One-Eyed Willie';
console.log(name == 'Jake');
console.log(name == 'Chester');
console.log(name == 'One-Eyed Willie');

let pirateShip = 'The Black Plague';
console.log('The Black Plague');

let pirates = 'hats' + 'parrots' + 'boots';

console.log(pirates == 'hats' + 'parrots' + 'boots');
console.log(pirates == 'hats');
